                       ...
                       <div class="col-md-4 product-men no-pad-men">
                           <div class="men-pro-item simpleCart_shelfItem">
                               <div class="men-thumb-item">
                                   <img src="{{asset( $p->productPic )}}" alt="" class="pro-image-front">
                                   <img src="{{asset( $p->productPic )}}" alt="" class="pro-image-back">
                                   <div class="men-cart-pro">
                                       <div class="inner-men-cart-pro">
                                           <a href="{{route('single_product',$p->id)}}" class="link-product-add-cart">Quick View</a>
                                       </div>
                                   </div>
                               ...
                               <div class="item-info-product ">
                                   <h4><a href="{{route('single_product',$p->id)}}">{{ $p->productName  }}</a></h4>
