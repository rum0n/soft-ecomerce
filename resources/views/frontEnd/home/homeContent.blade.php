						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset( $pro->productPic )}}" alt="" class="pro-image-front">
									<img src="{{asset( $pro->productPic )}}" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="{{route('single_product',$pro->id)}}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
								...
								<div class="item-info-product ">
									<h4><a href="{{route('single_product',$pro->id)}}">{{ $pro->productName  }}</a></h4>
